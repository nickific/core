...
trait Provisioning {
	 ...
	 * @throws Exception
	 */
	public function theAdministratorCreatesTheseUsers(string $setDefaultAttributes, string $doNotInitialize, TableNode $table):void {
	 ...
	 * @throws Exception
	 */
	public function theUsersShouldBe(string $usersList):void {
	 ...
	 * @throws Exception
	 */
	public function theUsersShouldInclude(string $usersList):void {
		$this->verifyTableNodeColumnsCount($usersList, 1);
		$users = $usersList->getRows();
		$usersSimplified = \array_map(
			function ($user) {
	 ...
	 * @throws Exception
	 */
	public function theGroupsShouldBe(string $groupsList):void {
	 ...
	 * @throws Exception
	 */
	public function getArrayOfSubadminsResponded($resp):array {
		$listCheckedElements
	 ...
	 * @throws Exception
	 */
	public function userShouldBeEnabled(string $user) {
		$user = $this->getActualUsername($user);
		$fullUrl = $this->getBaseUrl()
			. "/ocs/v{$this->ocsApiVersion}.php/cloud/users/$user";
		$this->response = HttpRequestHelper::get(
